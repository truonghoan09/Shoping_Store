...
import { BestSellers, } from '../Product/ProductManage';
...
const HomePage : React.FC = () => {
    ...
    const handleClickSmallMenu = (item: string) => {
        switch (item) {
            case 'fresh' : {
                setFresh(true);
                setWoody(false);
                    ...
                    <div className={styles.backgroundFillter}>
                        <div className={styles.contentCountContainer}>
                            <div className={styles.leftSide}>
                                ...
                                <button className={styles.getNotifiedBut} onClick={() => {window.location.assign('/contact')}}>GET NOTIFIED</button>
                            </div>
