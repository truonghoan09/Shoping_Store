...
export const Discover1 : productsType = {
    brand: 'A.N. OTHER',
    price: '$15',
    optionName: '',
    content:  
        `<p >Includes 1.5ml samples of all four scents. Shipping is free and you get your $15 back when you buy a bottle.</p>
            <div >
            ...
            <p >This is a demo store. You can purchase products like this from <a href={'https://an-other.com/'}>A.N. OTHER.</a></p>
        `,
    type: [{
        id: ['Discover1'],
        name:['Discover'],
...
export const Discover2 = {
    ...
    content:  
    `
    <p >Includes 1.5ml samples of all four scents. Shipping is free and you get your $15 back when you buy a bottle.Includes 1.5ml samples of all four scents. Shipping is free and you get your $15 back when you buy a bottle.</p>
    <div >
    <strong>Fresh: </strong><span>Drawing inspiration from the resurgence of classic gin cocktails, aldehydic top notes shake this clean blend of crisp juniper and Madagascan ginger alive with a freshness that fizzes and excites the senses. Metallic musk unifies a perfectly mixed blend, enhancing each note and complementing the composition.</span>
    <br/>
...
export const LeatherRoll = {
    ...
    content:  
    `
    <p >Carry the full collection in a leather roll featuring dedicated pockets for each fragrance, handmade in Europe by artisan craftsmen using the finest leather.</p>
...
export const SmoothProduct = {
    ...
    <br/>
            ...
            <p >Read more about the Perfumer who created this scent here.</p>
            <p >This is a demo store. You can purchase products like this from <a href={'https://an-other.com/'}>A.N. OTHER.</a></p>
        `,
        type: [{
            id: [],
...
export const TravelCase = {
    ...
    content: 
    `
    <p >Travel in style with a minimalistic travel case made from eco-friendly material in a “cradle to grave” sustainable manufacturing process.</p>
    <p >This is a demo store. You can purchase products like this from <a href={'https://an-other.com/'}>A.N. OTHER.</a></p>
    `,
    type: [{
        id: [],
...
export const TravelSet = {
    ...
    content:  
    `
    <p >7.5ml vials of the entire collection.</p>
    <div >
    <strong>Fresh: </strong><span>Drawing inspiration from the resurgence of classic gin cocktails, aldehydic top notes shake this clean blend of crisp juniper and Madagascan ginger alive with a freshness that fizzes and excites the senses. Metallic musk unifies a perfectly mixed blend, enhancing each note and complementing the composition.</span>
    <br/>
    <strong>Woody: </strong><span>Created to fully harness the power of the olfactory senses, this perfume utilizes the tranquil and nourishing qualities of sandalwood to enhance concentration and awaken intuition. An infusion of lush, effervescent pear at the top adds a distinct uplifting quality and an unmistakably modern appeal.</span>
